...
You could keep your Terraform state locally, but we **strongly recommend** saving it on S3 with versioning turned on in that bucket. Configure a remote S3 store with a setting like below:
